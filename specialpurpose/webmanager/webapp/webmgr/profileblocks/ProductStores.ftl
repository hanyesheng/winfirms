    ...
    <#if productStoreRoles?has_content>
      <table class="basic-table uk-table" cellspacing="0">
        ...
        <#list productStoreRoles as productStoreRole>
          ...
          <tr>
            <td class="button-col">
              <a href="FindProductStoreRoles?partyId=${productStoreRole.partyId}&amp;productStoreId=${productStore.productStoreId}">${productStore.storeName?default("${uiLabelMap.ProductNoDescription}")} (${productStore.productStoreId})</a>
            </td>
