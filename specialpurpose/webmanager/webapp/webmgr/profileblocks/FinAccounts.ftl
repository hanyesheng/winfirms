...
<div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
    ...
    <br />
    <table id="fa-transactions" class="basic-table uk-table" cellspacing="0" cellpadding="2">
        <thead>
            <tr class="header-row">
...
<#if ownedFinAccountAuthList?has_content>
    <div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
        <table id="fa-authorizations" class="basic-table uk-table" cellspacing="0" cellpadding="2">
            <thead>
                <tr class="header-row">
