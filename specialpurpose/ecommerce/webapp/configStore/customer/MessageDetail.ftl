...
<div class="col-md-10 project-comm">
		<div class="space30">
		<h4 class="uppercase space30">
			<span><a href="<@ofbizUrl>messageDissListReceive</@ofbizUrl>">${uiLabelMap.CommunicationEventRead}</a></span>
			&nbsp;/&nbsp;
			<span><a href="<@ofbizUrl>messageDissListReceive?ReadStatus=false</@ofbizUrl>">${uiLabelMap.CommunicationEventNoread}</a></span>
		</h4>
    <div class="boxlink">
    <#if (communicationEvent.partyIdFrom! != (userLogin.partyId)!)>
      ...
      <a href="<@ofbizUrl>messageDissListReceive?ReadStatus=false</@ofbizUrl>" class="submenutextright">${uiLabelMap.EcommerceViewList}</a>
    </div>
