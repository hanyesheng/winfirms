...
<div class="screenlet md-card" style="margin-top: 25px;">
  <div class="screenlet-body md-card-content uk-overflow-container">
  	...
  	<form method="post" action="<@ofbizUrl>updateProjectRecruit</@ofbizUrl>" id="EditProductContentSimpleText" class="basic-form" onsubmit="javascript:submitFormDisableSubmits(this)" name="EditProductContentSimpleText">
		  <input type="hidden" name="productId" value="${productId}" id="EditProductContentSimpleText_productId">
		  <input type="hidden" name="productContentTypeId" value="SPECIALINSTRUCTIONS">
