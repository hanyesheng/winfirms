...
<div class="md-card">
	<div class="md-card-toolbar">
    	<h3 class="md-card-toolbar-heading-text">${uiLabelMap.MyCourseCreate}</h3>
   	</div>
	    ...
	    <table class="uk-table uk-table-bordered uk-table-hover">
	    	...
	    	<#assign CreatedCol = 0>
	      	<#list Product as Product>
	            ...
	            <td valign="center">
	              <a href="<@ofbizUrl>courseInfo?productId=${Product.productId}</@ofbizUrl>" target="_blank" class="button btn-border color3 btn-xs btn-radius" style="display: inline-table;"><i class="fa fa-edit"></i>&nbsp;${uiLabelMap.CommonEdit}</a>
	            </td>
	          </tr>
