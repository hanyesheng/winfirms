  ...
  <table class="uk-table">
    ...
    <tr>
      <th>${uiLabelMap.OrderProduct}</th>
    	<th colspan="4">${uiLabelMap.OrderQtyOrdered}</th>
    ...
    <#list orderItems as orderItem>
      ...
      <#if maySelectItems?default("N") == "Y" && (orderHeader.statusId != "ORDER_SENT" && orderItem.statusId != "ITEM_COMPLETED" && orderItem.statusId != "ITEM_CANCELLED" && pickedQty == 0)>
        <tr>
          ...
          <td colspan="4"><a href="javascript:document.addCommonToCartForm.action='<@ofbizUrl>cancelOrderItem</@ofbizUrl>';document.addCommonToCartForm.submit()" class="buttontext">${uiLabelMap.CommonCancel}${uiLabelMap.CommonOrder}</a>
    ...
    <tr>
      <td colspan="7">${uiLabelMap.OrderGrandTotal}</th>
      <td>
