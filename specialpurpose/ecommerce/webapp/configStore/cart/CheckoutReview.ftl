...
<#if cart?? && 0 < cart.size()>
  ${screens.render("component://ecommerce/widget/configStore/OrderScreens.xml#orderheader")}
  <br />
  ${screens.render("component://ecommerce/widget/configStore/OrderScreens.xml#orderitems")}
