...
<div class="container">
	<ul class="nav nav-tabs">
		...
		<li class="col-md-4 <#if parameters.detailId?? && parameters.detailId = "childproject">active</#if>" ><a href="/store/products/p_${productId}?detailId=childproject"><i class="fa fa-pencil"></i>${uiLabelMap.VentureProject}</a></li>
