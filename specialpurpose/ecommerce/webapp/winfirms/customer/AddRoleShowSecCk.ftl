...
<div class="md-card">
	...
	<div class="margin-top-30">
		<div class="row">
		    ...
		    <div class="col-md-12">
		    <form action="<@ofbizUrl>ckRoleUpdateProductContent</@ofbizUrl>" method="post" style="margin: 0;" name="productForm">
		    ...
		    <div class="col-md-12">
			    ...
			    <form method="post" enctype="multipart/form-data" action="<@ofbizUrl secure="true">ckRoleUploadProductImage?productId=${productId}&amp;upload_file_type=original</@ofbizUrl>" name="imageUploadForm">
				...
				<form id="addAdditionalImagesForm" method="post" action="<@ofbizUrl>ckRoleAddAdditionalImagesForProduct</@ofbizUrl>" enctype="multipart/form-data">
		        ...
		        jQuery.ajax({
		            ...
		            success: function() {
				        ...
				        jQuery.ajax({
				            url: ajaxUrl,
			            	type: 'POST',
				            data: {"partyId" : '${partyId}',"roleTypeId" : 'BUSINESSMAN'},
				            error: function(msg) {
				            ...
				            success: function(msg) {
						        ...
						        jQuery.ajax({
						            url: ajaxUrl,
					            	type: 'POST',
						            data: {"partyId" : '${partyId}',"fromDate" : '${nowTimestamp}',"roleTypeId" : 'BUSINESSMAN',"productId" : '${product.productId}'},
						            error: function(msg) {
    	...
    	<div class="alert info"><a href="javascript:void(0);" onclick="javascript:verify();" class="button btn-border btn-small btn-radius white btn-center">${uiLabelMap.CompleteRoleVerify}</a></div>		
		</#if>
	</div>
	</#if>
</div>
