...
<head>
  ...
  <title>${(productStore.storeName)!}
  	<#if titleProperty?has_content>  : ${uiLabelMap.get(titleProperty)}</#if>
  </title>
  ...
  <link rel="stylesheet" href="/images/winfirms/css/profileStyle.css" type="text/css"/>
  <link rel="stylesheet" href="/images/winfirms/css/video-js.css" type="text/css"/>
  <#if menuCol?? && menuCol = "2">
	<link rel="stylesheet" href="/altair/css/dropify.css" type="text/css"/>
	</#if>
  ...
  <script src="/images/winfirms/video/video.min.js"></script>
</head>
