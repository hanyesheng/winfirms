...
<div class="screenlet md-card" style="margin-top: 25px;">
  <div class="screenlet-body md-card-content uk-overflow-container">
  	...
  	<form method="post" action="<@ofbizUrl>updateCourseVideo</@ofbizUrl>" id="EditProductContentSimpleText" class="basic-form" onsubmit="javascript:submitFormDisableSubmits(this)" name="EditProductContentSimpleText">
