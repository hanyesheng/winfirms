			...
			<#list CommunicationEventAndRoleRead as CommunicationEventAndRoleRead>
				...
				<li>
	                ...
	                <div class="md-card-list-item-content-wrapper wrapper-full">
	                    ...
	                    <form class="md-card-list-item-reply"  method="post" action="<@ofbizUrl secure="true">createDisscussProfile</@ofbizUrl>" name="CreateTopicEvent_${CommunicationEventAndRoleRead.communicationEventId}" onsubmit="return checkIP1();">
	                        <!--回复提交的表单-->
				...
				<#if CommunicationEventAndRoleRead.roleStatusId = "COM_ROLE_CREATED"  && CommunicationEventAndRoleRead.partyIdFrom != partyId>
