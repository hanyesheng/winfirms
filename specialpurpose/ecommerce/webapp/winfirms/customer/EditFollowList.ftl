                ...
                <div class="uk-vertical-align">
                    <div class="uk-vertical-align-middle">
                        <ul id="contact_list_filter" class="uk-subnav uk-subnav-pill uk-margin-remove">
                            ...
                            <li data-uk-filter="INVESTORS"><a href="#">${uiLabelMap.Investors}</a></li>
                            <li data-uk-filter="COMPANY"><a href="#">${uiLabelMap.CommonCompany}</a></li>
                            <li data-uk-filter="INCUBATOR"><a href="#">${uiLabelMap.Invubator}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
	    ...
	    <#if shoppingListItemDatas?has_content>
	        <#-- Pagination -->
	          <#list shoppingListItemDatas[lowIndex-1..highIndex-1] as shoppingListItemData>
	            ...
	            <form method="post" action="<@ofbizUrl>removeFromFollowing</@ofbizUrl>" name='removeform_${shoppingListItem.shoppingListItemSeqId}'>
