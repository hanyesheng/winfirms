...
<h3>${uiLabelMap.ProductResultOfImageUpload}</h3>
    ...
    <form action="<@ofbizUrl>updateProjectInfo</@ofbizUrl>" method="post" style="margin: 0;" name="productForm">
        <input type="hidden" name="productId" value="${productId!}"/>
        <table cellspacing="0" class="basic-table uk-table">
            <tr>
                <td align="right" valign="top"><b>${uiLabelMap.ProjectName}</b></td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td align="right" valign="top"><b>${uiLabelMap.OneWordInformation}</b></td>
                <td>&nbsp;</td>
                <td colspan="4" valign="top">
