...
<#-- right side -->
  ...
  <#if orderItemShipGroups?has_content>
    <h4>${uiLabelMap.OrderShippingInformation}</h4>
    <#-- shipping address -->
    <#assign groupIdx = 0>
    <#list orderItemShipGroups as shipGroup>
      ...
      <table class="table table-striped">
        <#if shippingAddress?has_content>
      		<tr>
                <td>${uiLabelMap.OrderDestination}</td> <td>[${groupNumber}]</td>
            </tr>
            <#if shippingAddress.toName?has_content>
            <tr>
            	<td>${uiLabelMap.CommonTo}</td> <td>${shippingAddress.toName}</td>
            </tr>
            </#if>
            ...
            <tr>
            	<td>${uiLabelMap.PartyAddrAttnName}</td> <td> ${shippingAddress.attnName}</td>
            </tr>
            </#if>
             
            <tr>
            	<td>${uiLabelMap.ReceiveAddress}</td>
            	<td>${shippingAddress.address1}
        ...
        <tr>
            <td>${uiLabelMap.OrderTrackingNumber}</td>
            <td>
        ...
        <tr>
          ...
          <td>${uiLabelMap.OrderSplittingPreference}</td>
          <td>
        ...
        -->
          ...
          <tr>
          <td>${uiLabelMap.OrderInstructions}</td>
          <td>${shippingInstructions}</td>
          </tr>
          </#if>
          ...
          <#if productStore.showCheckoutGiftOptions! != "N">
	        ...
	        <tr>
	           <td>${uiLabelMap.OrderGiftMessage}</td>
	           <td>${giftMessage}</td>
	        </tr>
	        </#if>
          </#if>
