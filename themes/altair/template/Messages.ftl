...
<#escape x as x?html>
  ...
  <#if (errorMessage?has_content || errorMessageList?has_content)>
    <div id="content-messages" class="uk-alert uk-alert-danger" style="z-index: 9999;text-align: center;margin: 0 auto;position: fixed;right: 10%;left: 10%;"
  ...
  <div id="content-messages" class="uk-alert uk-alert-info" style="z-index: 9999;text-align: center;margin: 0 auto;position: fixed;right: 10%;left: 10%;"
      onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
      <a href="#" class="uk-alert-close uk-close"></a>
