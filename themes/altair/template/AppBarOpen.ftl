  ...
  <#assign show_last_menu = true>
    ...
    <ul id="breadcrumbs">
	    ...
	    <#list displayApps as display>
	      ...
	      <#else>
	        <#if selected><li><a href="${thisURL + externalKeyParam}"<#if uiLabelMap??> title="${uiLabelMap[display.description]}">${uiLabelMap[display.title]}<#else> title="${display.description}">${display.title}</#if></a></li></#if>
	      </#if>
	    </#list>
