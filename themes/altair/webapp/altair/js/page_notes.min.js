...
altair_notes = {
	...
	open_note: function() {
		var t = function(t) {
			$card_note.find("#note_title").val(t.children(".md-list-heading").text()), $card_note.find("#note_content").val("Note " + t.attr("data-note-id") + " content \r\nLorem ipsum dolor sit amet, consectetur adipisicing elit. A amet beatae eaque earum, eligendi error et iste iure iusto magni minus obcaecati quas qui quis quisquam, sit suscipit voluptas voluptatum.")
		};
