! function(t, e) {
	...
	st.prototype.code = 0, st.prototype.message = "", st.prototype.status = null, st.errorTypes = ["MEDIA_ERR_CUSTOM", "MEDIA_ERR_ABORTED", "MEDIA_ERR_NETWORK", "MEDIA_ERR_DECODE", "MEDIA_ERR_SRC_NOT_SUPPORTED", "MEDIA_ERR_ENCRYPTED"], st.defaultMessages = {
		1: "视频播放被终止",
		2: "网络错误导致视频下载中途失败",
		3: "视频因格式不支持或者服务器或网络的问题无法加载",
		4: "由于视频文件损坏或是该视频使用了你的浏览器不支持的功能，播放终止。",
		5: "视频已加密，无法解密。"
	};
	...
	Qr.prototype.controlText_ = "播放视频", En.registerComponent("BigPlayButton", Qr);
	var Zr = function(t) {
		function e(n, r) {
			Be(this, e);
			var i = Ve(this, t.call(this, n, r));
	...
	var ti = function(t) {
		...
		return Fe(e, t), e.prototype.buildCSSClass = function() {
			...
			this.removeClass("vjs-ended"), this.removeClass("vjs-paused"), this.addClass("vjs-playing"), this.controlText("暂停")
		}, e.prototype.handlePause = function(t) {
			this.removeClass("vjs-playing"), this.addClass("vjs-paused"), this.controlText("播放")
		}, e.prototype.handleEnded = function(t) {
			this.removeClass("vjs-playing"), this.addClass("vjs-ended"), this.controlText("重新播放"), this.one(this.player_, "seeked", this.handleSeeked)
		}, e
	}(Jr);
	ti.prototype.controlText_ = "播放", En.registerComponent("PlayToggle", ti);
	var ei = function(t) {
		function e(n, r) {
			Be(this, e);
			var i = Ve(this, t.call(this, n, r));
	...
	ei.prototype.controlText_ = "时间", En.registerComponent("TimeDisplay", ei);
	var ni = function(t) {
		function e(n, r) {
			Be(this, e);
			var i = Ve(this, t.call(this, n, r));
	...
	ni.prototype.controlText_ = "当前时间", En.registerComponent("CurrentTimeDisplay", ni);
	var ri = function(t) {
		function e(n, r) {
			Be(this, e);
			var i = Ve(this, t.call(this, n, r));
	...
	ri.prototype.controlText_ = "时长", En.registerComponent("DurationDisplay", ri);
	var ii = function(t) {
		function e() {
			return Be(this, e), Ve(this, t.apply(this, arguments))
		}
	...
	var vi = function(t) {
		...
		return Fe(e, t), e.prototype.buildCSSClass = function() {
			...
			this.player_.isFullscreen() ? this.controlText("退出全屏") : this.controlText("全屏")
		}, e.prototype.handleClick = function(t) {
			this.player_.isFullscreen() ? this.player_.exitFullscreen() : this.player_.requestFullscreen()
		}, e
	}(Jr);
	vi.prototype.controlText_ = "全屏", En.registerComponent("FullscreenToggle", vi);
	var yi = function(t, e) {
	...
	bi.prototype.controlText_ = "静音", En.registerComponent("MuteToggle", bi);
	var Ti = function(t) {
		function e(n) {
			var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
	...
	po.prototype.options_ = {
		...
		languages: {},
		notSupportedMessage: "无法找到此视频兼容的源"
